        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text(L10n.string("ar.detail.overview"))
                            .font(.headline)
                    ...
                    HStack(spacing: 12) {
                        Button(action: {}) {
                            Label(L10n.string("ar.action.narration"), systemImage: "book.fill")
                        ...
                        Button(action: {}) {
                            Label(L10n.string("ar.action.navigate"), systemImage: "arrow.triangle.turn.up.right.diamond")
                                .frame(maxWidth: .infinity)
                                .padding()
                                .background(.green)
                                .foregroundStyle(.white)
            ...
            .navigationTitle(L10n.string("ar.poi.detail.title"))
